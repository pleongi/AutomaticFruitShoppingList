...
flags.DEFINE_string('images_dir', 'images', 'Name of the directory contatining images')
flags.DEFINE_string('images_sub_folder', 'train', 'train or test')
...
flags.DEFINE_string('xmls_dir', 'bounding_boxes', 'Name of the directory contatining xmls')
flags.DEFINE_string('label_map_path', '', 'Path to label map proto')
flags.DEFINE_string('tfrecord_filename', 'data', 'Name of TFRecord file')
flags.DEFINE_bool('use_xmls', True, 'True if xmls with bouding box is provided')
  ...
  if(True == FLAGS.use_xmls):
     ...
     if 'object' in data:
        for obj in data['object']:
          class_name = obj['name']
          pixel_val = int(label_map_dict[class_name])
...
def main(_):
  ...
  images_dir_path_and_sub_folder = os.path.join(images_dir_path, FLAGS.images_sub_folder)
